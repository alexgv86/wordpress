										   ...
										   <div class="product-item-utility">
												<ul>
													...
													if( class_exists( 'YITH_WCQV' ) ) { ?>
														<li>
														<a class="popup-info product-preview yith-wcqv-button" data-product_id="<?php echo esc_attr( $product->get_id() );?>" data-tippy-content="<?php echo esc_attr( get_option( 'yith-wcqv-button-label' ) ); ?>" href="#"><span><?php esc_html_e('Preview','supermarket') ;?></span></a>
														</li>
													<?php }
